...
import com.example.musiqal.database.local.UserSettingSharedPref
...
//        mainViewModel.deleteAllSavedTrackItem()
    ...
    private fun checkAppUnderRepairing() {

        val firebaseDatabase = FirebaseDatabase.getInstance()
        val fireBaseReference = firebaseDatabase.getReference("App Under Build")
//        fireBaseReference.setValue(false)
        fireBaseReference.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                if (snapshot != null) {
                    ...
                    if (value != null && value) {
                        MakingToast(this@MainActivity).toast(
                            "App is under build",
    ...
    private fun checkFirstTimeOpen() {
        if (!UserSettingSharedPref(this).get(UserSettingSharedPref.openFirstTime)) {
            isFirstTime = false
...
//        listOfDownloads.add(
//            DownloadInfo(
//                currentListOfItems.get(1).snippet.title,
//                trackDuration,
//                currentListOfItems.get(1).snippet.resourceId.videoId
//            )
//        )
//        listOfDownloads.add(
//            DownloadInfo(
//                currentListOfItems.get(2).snippet.title,
//                trackDuration,
//                currentListOfItems.get(2).snippet.resourceId.videoId
//            )
//        )
//        listOfDownloads.add(
//            DownloadInfo(
//                currentListOfItems.get(3).snippet.title,
//                trackDuration,
//                currentListOfItems.get(3).snippet.resourceId.videoId
//            )
//        )
//        listOfDownloads.add(
//            DownloadInfo(
//                currentListOfItems.get(4).snippet.title,
//                trackDuration,
//                currentListOfItems.get(4).snippet.resourceId.videoId
//            )
//        )
//        listOfDownloads.add(
//            DownloadInfo(
//                currentListOfItems.get(5).snippet.title,
//                trackDuration,
//                currentListOfItems.get(5).snippet.resourceId.videoId
//            )
//        )
//        listOfDownloads.add(
//            DownloadInfo(
//                currentListOfItems.get(6).snippet.title,
//                trackDuration,
//                currentListOfItems.get(6).snippet.resourceId.videoId
//            )
//        )
//
    ...
    override fun onRequestPermissionsResult(
        ...
        if (requestCode == REQUEST_STORAGE_PERMISSION) {
            if (permissions.isEmpty() || grantResults[0] != PackageManager.PERMISSION_GRANTED) {
                MakingToast(this).toast(
                    "Accept storage permission to start download",
                    MakingToast.LENGTH_SHORT
                )
            } else {
